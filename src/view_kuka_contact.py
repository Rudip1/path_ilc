...
ILC (the contact task).
    ...
    python src/view_kuka_contact.py --live     # interactive window
...
from view_kuka.py with the contact plant.
"""
...
from view_kuka import train, capture_pass, SETTLE, HOLD  # noqa: E402
